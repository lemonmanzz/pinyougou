                    ...
                    <div id="specification" class="summary-wrap clearfix">
							<#list customAttributeItems as attr>
							  <dl>
								  ...
								  <#if attr.value??>
								       <dd>
                                           <a href="javascript:void(0);" class=" selected">${attr.value}<span title="点击取消选择">&nbsp;</span>
                                           </a>
                                       </dd>
								  </#if>
							...
							<#list specificationItems as spec>
							    	<dl>
                                        ...
                                        <dd><a href="javascript:;"  ng-click="selectSpec('${spec.attributeName}','${value}')"
